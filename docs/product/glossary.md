...
| Increment | The focused implementation produced for one Human-approved TASK. |
| Reviewer | The independent actor invited by the Human to review a task in `In Review` and record findings as a task comment. |

Terms not listed here must be defined during task refinement before they affect acceptance criteria.
