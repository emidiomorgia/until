...
6. Complete the `Final Summary` as structured Markdown for independent review, using the required template below. The field must include the exact shell commands executed and the task-scoped modified file list.
